...
uint8_t db_rm_entry_by_num(const char* dbpath, size_t number);/*removes line of information from database by a number of the line*/
uint8_t db_ins_entry_by_num(info_t* info,char* dbpath, size_t number); /*inserts line of information to the database by number*/
uint8_t db_change_entry_by_num(info_t* info,char* dbpath, size_t number); /*changes line of information at the database by number*/
